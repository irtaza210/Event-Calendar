...
// insert event title, date, time, category and respective username into events table
...
$stmt = $mysqli->prepare("insert into events (name, username, date, time, category) values (?,?,?,?,?)");
        if(!$stmt){
        ...
        $stmt->bind_param('sssss', $eventtitle, $user_id, $eventdate, $eventtime, $eventcategory);
